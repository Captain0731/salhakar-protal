  ...
  return (
    <div className="min-h-screen pt-28" style={{ backgroundColor: '#F9FAFC' }}>
      ...
      <div id="cookie-policy-section" className="w-full max-w-7xl mx-auto px-4 py-8 border-2 border-gray-200 shadow-lg" style={{ scrollMarginTop: '100px' }}>
        ...
        <p className="mb-6" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif" }}>
        ...
        {/* What Are Cookies */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>2. What Are Cookies</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>Cookies may be:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Legal Basis */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>3. Legal Basis for Using Cookies</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Types of Cookies */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>4. Types of Cookies We Use</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>We categorize the cookies used on our website as follows:</p>
          
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>A. Strictly Necessary Cookies</p>
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>Examples include:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>B. Functional Cookies</p>
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>C. Performance and Analytics Cookies</p>
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>D. Advertising and Marketing Cookies</p>
          <p className="mb-2" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Third-Party Cookies */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>5. Third-Party Cookies and Tracking Technologies</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Managing Cookies */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>6. Managing Cookies</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>You have full control over cookie usage. You may:</p>
          <ol className="list-decimal pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>Instructions for common browsers:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>7. Data Storage and Security of Cookie Data</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>8. Data Sharing and Transfer</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Changes to Policy */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>9. Changes to This Policy</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Grievance Redressal */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>10. Grievance Redressal</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Governing Law */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>11. Governing Law and Jurisdiction</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Contact Information */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>12. Contact Information</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
