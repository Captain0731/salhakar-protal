  ...
  return (
    <div className="min-h-screen pt-28" style={{ backgroundColor: '#F9FAFC' }}>
      ...
      <div id="privacy-policy-section" className="w-full max-w-7xl mx-auto px-4 py-8 border-2 border-gray-200 shadow-lg" style={{ scrollMarginTop: '100px' }}>
        ...
        {/* Definitions */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>2. Definitions</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>For the purpose of this Policy:</p>
          <ul className="space-y-3 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>3. Information We Collect</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>We may collect and process the following categories of information:</p>
          
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>Information You Provide:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
          ...
          <p className="mb-2 font-semibold" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>Information Collected Automatically:</p>
          <ul className="list-disc pl-6 mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Consent */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>5. Consent</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Data Security */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>9. Data Security</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* User Rights */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>10. User Rights Under Indian Law</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
        ...
        {/* Contact Information */}
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-3" style={{ color: '#1E65AD', fontFamily: "'Roboto', sans-serif" }}>17. Contact Information</h2>
          <p className="mb-4" style={{ color: '#8C969F', fontFamily: "'Roboto', sans-serif", lineHeight: '1.6' }}>
